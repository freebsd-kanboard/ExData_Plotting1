...
# 2 rows and 2 columns, by row
par(mfrow=c(2,2), mar = c(4, 4, 2, 1), oma = c(0, 0, 2, 0))

# plot Global Active Power, top left corner
...
# plot Energy Sub Metering, bottom left corner
...
# plot Global Reactive Power, bottom right corner
